...
void SetWindowTransparency(HWND hWnd, BYTE alpha) {
    ...
    BITMAPINFO bmi = { sizeof(BITMAPINFOHEADER), width, -height, 32, BI_RGB };
...
static struct {
    ...
    { L"https://www.deepl.com/en/write", L"Deepl write" },
    { L"https://jules.google.com/", L"Google Jules" },
    { L"https://google.com/aimode", L"Google IAMODE" } 
    ...
    if (hUser) {
        ...
        if (SetWindowCompositionAttribute) {
            ...
            ACCENT_POLICY policy = {
                ...
                finalColor,         // Tint color with alpha
                0                   // Animation ID
            };
    ...
    case WM_CREATE: {
      ...
      // Create brush for tab control background
       ...
       EnableBlur(tabControl);
        ...
        for (register int i = 0; i < TAB_COUNT; ++i) {
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR, int nCmdShow) {
    ...
    wc.lpszClassName = CLASS_NAME;
        ...
        HANDLE hMutex = CreateMutex(NULL, TRUE, L"slan.be");
